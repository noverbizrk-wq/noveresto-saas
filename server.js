...
const restaurantLoyaltyRoutes = require('./restaurant-loyalty-routes')(pool, authMiddleware, restaurantScopeMiddleware)
...
app.use('/api/v1/restaurant', restaurantLoyaltyRoutes)
